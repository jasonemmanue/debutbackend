...
// Ce composant serveur récupère et affiche les événements
export default async function CompanyEventsPage() {
    ...
    // Récupérer les événements créés par l'utilisateur/entreprise
                            ...
                            <CardContent>
                                ...
                                <div className="flex items-center text-sm text-gray-500 space-x-4">
                                    <div className="flex items-center">
                                        ...
                                        <span>
                                            {event.date_debut ? format(new Date(event.date_debut), "d MMMM yyyy 'à' HH:mm", { locale: fr }) : 'Date non définie'}
                                        </span>
                                    </div>
                                    <span>-</span>
                                    <div className="flex items-center">
                                        <span>
                                             {event.date_fin ? format(new Date(event.date_fin), "d MMMM yyyy 'à' HH:mm", { locale: fr }) : 'Date non définie'}
                                        </span>
                                    </div>
                                </div>
                            </CardContent>
